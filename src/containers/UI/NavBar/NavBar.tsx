		...
		<>
			<li>
				<Link className="navbar-button" to="lore-section" smooth onClick={() => toggleDrawer(false)}>
					<Button size='large' color="inherit">Lore</Button>
				</Link>
			</li>
			<li>
				<Link className="navbar-button" to="mmaps-section" smooth onClick={() => toggleDrawer(false)}
					  offset={isTabletOrMobileDevice ? 50 : 10}>
					<Button size='large' color="inherit">Maps</Button>
				</Link>
			</li>
			<li>
				<Link className="navbar-button" to="war-section" smooth onClick={() => toggleDrawer(false)}
					  offset={isTabletOrMobileDevice ? 30 : 180}>
					<Button size='large' color="inherit">War</Button>
				</Link>
			</li>
		</>
	);
